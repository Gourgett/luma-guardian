...
<head>
    ...
    <style>
        ...
        .log { font-size: 0.8em; opacity: 0.8; height: 150px; overflow-y: scroll; border: 1px solid #21262d; padding: 5px; }
    </style>
</head>
<body>
    <div class="card">
    ...
    <div class="card">
        <div class="header">📜 HISTORY (LAST 50)</div>
        <div id="history-log" class="log" style="height: 300px;">
             <div style="padding:10px; text-align:center;">(History log syncs with active session events)</div>
        </div>
    </div>
